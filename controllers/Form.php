...
class Form extends MY_Controller {
    ...
    public function create_new_form() {
        ...
        $data['meta_title'] = 'Test | Create new Form';
        $data['meta_keywords'] = 'Test | Create new Form';
        $data['meta_desc'] = 'Test | Create new Form';
        ...
        $data['custom_file_upload'] = 'admin/stepforms/custom_file_upload';
        $data['footer'] = 'admin/template/footer';
        $this->load->vars($data);
        $this->load->view($this->admin_dashboard);
    }